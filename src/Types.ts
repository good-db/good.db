...
export interface IAsyncGoodDB {
  ...
  /**   * Filter values in an array stored in a key.   * @param key - The key of the array to filter.   * @param callback - The callback filter function to use.   * @param options - The options to use.   * @returns A promise that resolves to an array of filtered values.   */  filter(key: string, callback: (value: any, index: number, obj: any[]) => unknown, options?: methodOptions): Promise<any[]>;  /**   * Find a value in an array and update it.   * @param key - The key of the array to search.   * @param findCallback - The callback function to find the element.   * @param updateCallback - The callback function to update the found element.   * @param options - The options to use.   * @returns A promise that resolves to the updated element or undefined if not found.   */  findAndUpdate(key: string, findCallback: (value: any, index: number, obj: any[]) => unknown, updateCallback: (value: any, index: number, obj: any[]) => any, options?: methodOptions): Promise<any>;
/** * Find multiple values in an array and update them. * @param key - The key of the array to search. * @param findCallback - The callback function to find the elements. * @param updateCallback - The callback function to update the found elements. * @param options - The options to use. * @returns A promise that resolves to an array of updated elements. */ findAndUpdateMany(key: string, findCallback: (value: any, index: number, obj: any[]) => unknown, updateCallback: (value: any, index: number, obj: any[]) => any, options?: methodOptions): Promise<any[]>;/** * Set multiple key-value pairs at once. * @param data - An object with key-value pairs to set. * @param options - The options to use. * @returns A promise that resolves to a boolean indicating the success of the operation. */ setMany(data: Record<string, any>, options?: methodOptions): Promise<boolean>;/** * Get multiple values by their keys at once. * @param keys - An array of keys to get. * @param options - The options to use. * @returns A promise that resolves to an object with key-value pairs. */ getMany(keys: string[], options?: methodOptions): Promise<Record<string, any>>;/** * Delete multiple keys at once. * @param keys - An array of keys to delete. * @param options - The options to use. * @returns A promise that resolves to a boolean indicating the success of the operation. */ deleteMany(keys: string[], options?: methodOptions): Promise<boolean>;
...
export interface ISyncGoodDB {
  ...
  /**   * Filter values in an array stored in a key.   * @param key - The key of the array to filter.   * @param callback - The callback filter function to use.   * @param options - The options to use.   * @returns An array of filtered values.   */  filter(key: string, callback: (value: any, index: number, obj: any[]) => unknown, options?: methodOptions): any[];  /**   * Find a value in an array and update it.   * @param key - The key of the array to search.   * @param findCallback - The callback function to find the element.   * @param updateCallback - The callback function to update the found element.   * @param options - The options to use.   * @returns The updated element or undefined if not found.   */  findAndUpdate(key: string, findCallback: (value: any, index: number, obj: any[]) => unknown, updateCallback: (value: any, index: number, obj: any[]) => any, options?: methodOptions): any;
/** * Find multiple values in an array and update them. * @param key - The key of the array to search. * @param findCallback - The callback function to find the elements. * @param updateCallback - The callback function to update the found elements. * @param options - The options to use. * @returns An array of updated elements. */ findAndUpdateMany(key: string, findCallback: (value: any, index: number, obj: any[]) => unknown, updateCallback: (value: any, index: number, obj: any[]) => any, options?: methodOptions): any[];/** * Set multiple key-value pairs at once. * @param data - An object with key-value pairs to set. * @param options - The options to use. * @returns A boolean indicating the success of the operation. */ setMany(data: Record<string, any>, options?: methodOptions): boolean;/** * Get multiple values by their keys at once. * @param keys - An array of keys to get. * @param options - The options to use. * @returns An object with key-value pairs. */ getMany(keys: string[], options?: methodOptions): Record<string, any>;/** * Delete multiple keys at once. * @param keys - An array of keys to delete. * @param options - The options to use. * @returns A boolean indicating the success of the operation. */ deleteMany(keys: string[], options?: methodOptions): boolean;
